            ...
            >
              ...
              >
                ...
                {s.rootNode && !s.rootNode.children.length && (
                  <span className="ml-auto shrink-0 text-[10px] text-zinc-400">base</span>
                )}
              ...
              <button
                onClick={(e) => {
                  ...
                  if (
                    s.rootNode &&
                    !window.confirm(
                      `Delete session "${s.label}"? This cannot be undone.`
                    )
                  ) {
                    return;
                  }
                ...
                className="ml-auto hidden shrink-0 rounded p-0.5 text-zinc-400 transition-colors hover:bg-zinc-200 hover:text-zinc-600 group-hover:block dark:hover:bg-zinc-700 dark:hover:text-zinc-300"
